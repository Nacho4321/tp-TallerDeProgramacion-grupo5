...
public:
    CarRenderer(const char* windowTitle, 
        ...
        : sdl(SDL_INIT_VIDEO),
          ...
          sprites(renderer, Surface("data/cars/Mobile - Grand Theft Auto 4 - Miscellaneous - Cars.png")),
          texture_backround(renderer, Surface("data/cities/Game Boy _ GBC - Grand Theft Auto - Backgrounds - Liberty City.png")),
