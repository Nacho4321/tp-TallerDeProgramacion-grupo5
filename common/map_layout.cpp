...
#define MAP_WIDTH (640.0f / 4.5f)
#define MAP_HEIGHT (480.0f / 3.35f)
#define WALL_THICKNESS 0.25f // grosor de la pared en metros
...
void MapLayout::create_walls()
{
    ...
    shape_lower.SetAsBox(MAP_WIDTH / 2.0f, WALL_THICKNESS,
                         b2Vec2(MAP_WIDTH / 2.0f, MAP_HEIGHT + WALL_THICKNESS),
                         0.0f);
